    ...
    return (
        <section className="mt-16">
            <div className="flex items-center justify-between px-2 mb-6">
                ...
                <a className="group flex items-center gap-1 text-sm font-medium text-primary hover:text-primary/80 cursor-pointer" onClick={() => onNavigate && onNavigate('catalog')}>
                    Ver Todo
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                {/* Card 1 */}
                <a className="group relative block aspect-[4/5] overflow-hidden rounded-xl bg-surface-dark cursor-pointer" onClick={() => onNavigate && onNavigate('catalog')}>
                    <div
